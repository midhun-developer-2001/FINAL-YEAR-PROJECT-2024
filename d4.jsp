...
-->
  ...
  <tr>
    ...
    <td width="596"><p>&nbsp;</p>
      ...
      <tr>
        <td height="315"  align="center"><table width="897" border="1" align="center">
          <tr>
            <td width="891" height="35"><div align="center">GENERALIZATION</div></td>
          </tr>
          <tr>
            <td><div align="center">
                ...
                <tr>
                  <td width="892"><table width="898" height="22" border="0" align="center"> 
                    <tr>
                      ...
                      <td width="194" align="center">AGE</td>
                        <td width="247" align="center">SEX</td>
                        <td width="223" align="center">ZIPCODE</td>
                         <td width="216" align="center">DISEASE</td>
                        </tr>
                    </table></td>
                  </tr>
                <tr>
	...
	{  
	 ...
	 %>
                    <tr>
                      <td width="192"  align="center"> <%=rs.getString(1)%></td>
                        <td width="250"  align="center"> <%=rs.getString(2)%></td>
                        <td width="221"  align="center"> <%=rs.getString(3)%></td>
                        <td width="221"  align="center"> <%=rs.getString(4)%></td>
                  </tr> <%
