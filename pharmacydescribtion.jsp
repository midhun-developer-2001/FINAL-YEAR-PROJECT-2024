        ...
        <td height="31" ><table width="959" height="482" border="0">
          ...
          <tr>
            <td><table width="634" border="0" align="center">
                    <tr>
                      <td width="628" height="32"><div align="center" class="style2 style27"> PRESCRIPTION </div></td>
                    </tr>
                    <tr>
                      <td height="220"><table width="507" border="0" align="center">
		     <tr>
              <td width="117" height="34"><span class="style6 style26">Pharmacy ID </span></td>	
               <%
 int pro=0;
 int pro1=0;
 		try {
  ...
  %>  <%
          ...
          if (rs!=null) {  while(rs.next()){
           ...
           %>
              <td width="211"><span class="style25">
                <label>
...
&nbsp;&nbsp;&nbsp;                </label>
              ...
              <td><span class="style25">&nbsp;&nbsp;
                  <input type="submit" name="search" value="Search" class="buttons" onClick="return validatePage('a1','err_a1','Should Not Be Blank');"  />  
                  </span></td>
              <%
        }
        catch(Exception e)
        ...
        out.println(e);
            ...
            <tr>
              <td width="117" height="30"><span class="style6 style26">Medicine Name</span></td>
              <td width="211"><span class="style25">
                <label>
...
&nbsp;&nbsp;&nbsp;                </label>
            ...
            <tr>
              <td height="59"><span class="style6 style26">Describtion</span></td>
              <td><span class="style25">
                <label>
...
&nbsp;&nbsp;                </label>
            ...
            <tr>
              <td height="32"><span class="style6 style26">Amount</span></td>
              <td><span class="style25">
                <label>
...
&nbsp;&nbsp;&nbsp;                </label>
          ...
          <tr>
                      ...
                      <td class="style2 style25"><input type="submit" name="update" value="Update" class="buttons" onClick="return validatePage('a1|a2|a3|a4|a5','err_a1|err_a2|err_a3|err_a4|err_a5','Should Not Be Blank|Should Not Be Blank|Should Not Be Blank|Should Not Be Blank|Should Not Be Blank');"  />&nbsp;&nbsp;  &nbsp;&nbsp;  <input type="submit" name="Delete" value="Delete" class="buttons" onClick="return validatePage('a1','err_a1','Should Not Be Blank|Should Not Be Blank|Should Not Be Blank|Should Not Be Blank|Should Not Be Blank');"  /></td>
                      <td width="165" class="style2"><span class="style25">
                        <label>
