<%-- 
    Document   : p1
    Created on : Feb 15, 2022, 1:49:57 PM
    Author     : windows
--%>
        ...
        <td width="960"><table width="960" border="0">
          <tr>
            <td width="954"><table width="950" border="0">
              <tr>
                <td width="236"><img src="image/1_4.jpg" height="131"/></td>
                <td width="704"><div align="center"><span class="style23">A DATA INTEGRITY AND RELIABLE AUTHENTICATION SCHEME FOR STORING AND RETRIEVAL OF SENSITIVE HEALTH CARE RECORDS IN CLOUD </span></div></td>
              </tr>
            </table></td>
          </tr>
          <tr>
    ...
    <td width="596"><p>&nbsp;</p>
      ...
      <tr>
        <td height="376"  align="center"><table width="957" border="0">
          <tr>
            <td width="947" height="43">Welcome to Pharmacy Login </td>
          </tr>
          <tr>
            <td height="328">&nbsp;</td>
          </tr>
