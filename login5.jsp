<%-- 
    Document   : login5
    Created on : Feb 15, 2022, 1:51:12 PM
    Author     : windows
--%>
...
-->
    ...
    <body bgcolor="#CCCCCC"><form action="login5" method="post">
	<%
  ...
  <tr>
    ...
    <td width="631"><table width="512" border="0" align="center">
          <tr>
            <td width="506" height="36" align="center"><span class="style36">PHARMACY LOGIN</span></td>
          </tr>
          <tr>
