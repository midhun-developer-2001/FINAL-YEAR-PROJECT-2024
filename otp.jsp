<%-- 
    Document   : otp
    Created on : Oct 14, 2023, 1:05:59 PM
    Author     : WINDOWS
--%>
...
-->
    ...
    <body bgcolor="#CCCCCC"><form action="access" method="post">
	<%
          ...
          <tr>
            <td width="950"><table width="950" border="0">
              <tr>
                ...
                <td width="655" align="center"><span class="style23">A DATA INTEGRITY AND RELIABLE AUTHENTICATION SCHEME FOR STORING AND RETRIEVAL OF SENSITIVE HEALTH CARE RECORDS IN CLOUD</span></td>
              </tr>
            </table></td>
          </tr>
          <tr>
  ...
  <tr>
    ...
    <td width="590"><p align="justify">&nbsp;</p>
      ...
      <tr>
        <td height="31" ><table width="952" height="360" border="0">
  <tr>
    <td width="147" height="356">&nbsp;</td>
    <td width="631"><table width="512" border="0" align="center">
          <tr>
            <td width="506" height="36" align="center"><span class="style36">OTP Access </span></td>
          </tr>
          <tr>
            <td height="175" align="center"><table  align="center" width="411" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td width="125" class="style1"><span class="style45">Access Code <span class="style46">* </span></span></td>
    <td width="8"><label for="textfield"></label>
      <span id="errorcode1" class="error"></span></td>
    <td width="265">
      <label>
  
  <input type="file" id="a1" name="a1"  /><span id="err_a1"></span>      </label></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
      ...
      <input type="submit" name="s1" value="Submit" class="buttons"	onclick="return validatePage('a1|a2','err_a1|err_a2','User Name Should Not Be Blank|Password Should Not Be Blank');"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
