<%-- 
    Document   : login2
    Created on : Mar 2, 2020, 8:54:04 AM
    Author     : PERUMAL
--%>
...
-->
    ...
    <body bgcolor="#CCCCCC"><form action="login2" method="post">
	<%
  ...
  <tr>
    ...
    <td width="631"><table width="512" border="0" align="center">
          <tr>
            <td width="506" height="36" align="center"><span class="style36">LAB STAFF LOGIN</span></td>
          </tr>
          <tr>
