...
-->
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
	  ...
	  <a href="denter.jsp">Diagnosis</a>
	    <a href="d3.jsp">Disease Report</a>
  ...
  <tr>
   ...
   <tr>
      <td width="59" height="33" ><div align="center" class="style21 style3 style14"><strong>LId</strong></div></td>
      ...
      <td width="195"><div align="center" class="style21 style3 style14"><strong>Blood Pressure</strong></div></td>
	   <td width="195"><div align="center" class="style21 style3 style14"><strong>Temperature</strong></div></td>
    </tr>
   ...
   int vv=0,vv1=0,flag=0,f=0;
			...
			.executeQuery("select COUNT(distinct patientid)  from searchblock where doctorid='"+so.getAttribute("un") +"' and specialist='" + r5 + "' and fdate='"+f12+"' ");
                              ...
                              if(vv<100){
                                ...
                                String st1="",st2="";
                              if(flag==1){
                                  System.out.println("select * from etest where uid='"+a11+"'");
		ResultSet rs = st.executeQuery("select * from etest where uid='"+a11+"'");
...
int sts=0;
   ...
   sts=smt9.executeUpdate("insert into searchblock values('"+firstBlock.hashCode()+"','"+transaction1+"','" + r3 + "','" + r4 + "','" + r5 + "','" + a11 + "','"+st2+"','"+f11+"','"+f12+"','information')");						
	 %>
    ...
    <tr>
      ...
      <td width="102"><div align="center"><%=rs.getString(8)%></div></td>
	         <td width="150"><div align="center"><%=rs.getString(9)%></div></td>
      <td width="193"><div align="center"><%=rs.getString(10)%></div></td>
