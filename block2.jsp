...
-->
        ...
        <td width="964"><table width="960" border="0">
          <tr>
            <td width="954"><table width="958" border="0">
              <tr>
                <td width="235"><img src="image/1_4.jpg" height="131"/></td>
                <td width="713" align="center"><span class="style23">A DATA INTEGRITY AND RELIABLE AUTHENTICATION SCHEME FOR STORING AND RETRIEVAL OF SENSITIVE HEALTH CARE RECORDS IN CLOUD </span></td>
              </tr>
            </table></td>
          </tr>
          <tr>
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="dregister.jsp">Doctor Register</a><a href="hospital.jsp">Hospital Register</a>
    ...
    <div class="dropdown-content">
      ...
      <a href="block2.jsp"  class="active">Test Block</a>
  ...
  <tr>
   ...
   <tr>
      <td width="81" height="33" ><div align="center" class="style3 style19 style21">hashblock</div></td>
     
      <td width="121"><div align="center" class="style3 style19 style21"> transactions</div></td>
	  <td width="84"><div align="center" class="style3 style19 style21">Doctor Id </div></td>
    
	    <td width="102"><div align="center" class="style3 style19 style21">User ID </div></td>
		  
	    <td width="140"><div align="center" class="style3 style19 style21">Test</div></td>
		  <td width="124"><div align="center" class="style3 style19 style21">Date</div></td>
    </tr>
	...
	{  
		...
		ResultSet rs = st.executeQuery("select * from testblock ");
		if(rs!=null)
			{%>
    ...
    <tr>
      <td width="100" >   
              ...
              <%=rs.getString(1)%>
               ...
               <td width="175"><div align="center"><%=rs.getString(2)%></div></td>
        <td width="114"><div align="center"><%=rs.getString(3)%></div></td>
    
	         <td width="140"><div align="center"><%=rs.getString(5)%></div></td>
       
	         <td width="194"><div align="center"><%=rs.getString(7)%></div></td>
			 <td width="171"><div align="center"><%=rs.getString(8)%></div></td>
    <%
  index++;
													}
													} else 
