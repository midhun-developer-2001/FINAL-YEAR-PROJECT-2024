...
-->
    ...
    <body bgcolor="#CCCCCC"><form action="login" method="post">
	<%
  ...
  <tr>
    ...
    <td width="590"><p align="justify">&nbsp;</p>
      ...
      <tr>
        <td height="31" ><table width="952" height="394" border="0">
  <tr>
    <td width="147" height="390">&nbsp;</td>
    <td width="631"><table width="512" border="0" align="center">
          <tr>
            <td width="506" height="36" align="center"><span class="style36">USER LOGIN</span></td>
          </tr>
          <tr>
            <td height="175" align="center"><table  align="center" width="348" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td width="154" class="style1"><span class="style13">Username <span class="style41">* </span></span></td>
  ...
  <tr>
    <td class="style1"><span class="style13">Password<span class="style41"> * </span></span></td>
...
</table>    <p class="style42"><%=msg %></p></td>
          </tr>
        </table></td>
	<td width="160">&nbsp;</td>
  </tr>
