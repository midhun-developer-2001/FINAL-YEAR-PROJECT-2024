<%-- 
    Document   : etest
    Created on : 8 Mar, 2024, 10:55:50 PM
    Author     : Win11
--%>
...
sdf = new SimpleDateFormat("yyyy-M-dd hh:mm:ss");
 ...
 f12=sdf1.format(date);
   int vv=0,vv1=0,flag=0;
                                ...
                                String st1="",st2="";
                           System.out.println("select * from dtest where uid=(select userid from erequest where userid='"+request.getParameter("a1")+"')");
		ResultSet rs = st.executeQuery("select * from dtest where uid=(select userid from erequest where userid='"+request.getParameter("a1")+"')");
		if(rs!=null)
			{%>
