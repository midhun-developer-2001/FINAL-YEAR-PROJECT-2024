...
-->
    ...
    <table width="970" border="0" align="center" bgcolor="#FFFFFF">
      <tr>
        <td width="964"><table width="960" border="0">
          <tr>
            <td width="954"><table width="958" border="0">
              <tr>
                <td width="256"><img src="image/1_4.jpg" height="131"/></td>
                <td width="692"><div align="center"><span class="style23">A DATA INTEGRITY AND RELIABLE AUTHENTICATION SCHEME FOR STORING AND RETRIEVAL OF SENSITIVE HEALTH CARE RECORDS IN CLOUD </span></div></td>
              </tr>
            </table></td>
          </tr>
          <tr>
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content"><a href="hospital.jsp">Hospital Register</a>
    ...
    <div class="dropdown-content">
      ...
      <a href="historyblock.jsp"  class="active">History Block</a>
    </div>
  ...
  <tr>
    ...
    <td width="596"><p>&nbsp;</p>
      ...
      <tr>
        <td height="376"  align="center"><table width="953" border="0">
  <tr>
    <td width="947" height="31" align="center"><H1 class="style14 style20"><strong>Test Block </strong></H1> </td>
  </tr>
  <tr>
    <td class="style19"><table width="939" border="0" align="center">
              <tr>
                <td width="933"><table width="939" height="43" border="3" >
   <tr>
      <td width="81" height="33" ><div align="center" class="style3 style19 style21">
        <div align="center">hashblock</div>
      </div></td>
     
      <td width="121"><div align="center" class="style3 style19 style21"> 
        <div align="center">transactions</div>
      </div></td>
	  <td width="84"><div align="center" class="style3 style19 style21">
	    <div align="center">Doctor Id </div>
	  </div></td>
       <td width="102"><div align="center" class="style3 style19 style21">
         <div align="center">Specialist </div>
       </div></td>
	    <td width="102"><div align="center" class="style3 style19 style21">
		  ...
		  <td width="124"><div align="center" class="style3 style19 style21">
		  ...
		  <td width="124"><div align="center" class="style3 style19 style21">
		    <div align="center">Type</div>
              ...
              <tr>
                <td><table width="934" border="1"  align=center>
	...
	{  
		...
		ResultSet rs = st.executeQuery("select * from searchblock ");
		if(rs!=null)
			{%>
    ...
    <tr>
      <td width="99" >   
              ...
              <%=rs.getString(1)%>
               ...
               <td width="143"><div align="center"><%=rs.getString(2)%></div></td>
        <td width="102"><div align="center"><%=rs.getString(3)%></div></td>
    
	         <td width="124"><div align="center"><%=rs.getString(5)%></div></td>
       <td width="121"><div align="center"><%=rs.getString(6)%></div></td>
	         <td width="145"><div align="center"><%=rs.getString(8)%></div></td>
			 <td width="154"><div align="center"><%=rs.getString(10)%></div></td>
    <%
  index++;
													}
													} else 
