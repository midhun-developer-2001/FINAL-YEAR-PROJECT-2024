<%-- 
    Document   : login4
    Created on : Mar 2, 2020, 11:27:57 AM
    Author     : PERUMAL
--%>
...
-->
    ...
    <body bgcolor="#CCCCCC"><form action="login4" method="post">
	<%
  ...
  <tr>
    ...
    <td width="590"><p align="justify">&nbsp;</p>
      ...
      <tr>
        <td height="31" ><table width="952" height="390" border="0">
  <tr>
    <td width="147" height="386">&nbsp;</td>
    <td width="631"><table width="512" border="0" align="center">
          <tr>
            <td width="506" height="36" align="center"><span class="style36">NURSE LOGIN</span></td>
          </tr>
          <tr>
